...
Types.public_key = {
    ...
    toObject: function toObject(object) {
        ...
        if (debug.use_default && object === undefined) {
            return _travelchainjsWs.ChainConfig.address_prefix + "859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM";
        }
        _SerializerValidation2.default.required(object);
        return object.toString();
    },
...
Types.address = {
    ...
    toObject: function toObject(object) {
        ...
        if (debug.use_default && object === undefined) {
            return _travelchainjsWs.ChainConfig.address_prefix + "664KmHxSuQyDsfwo4WEJvWpzg1QKdg67S";
        }
